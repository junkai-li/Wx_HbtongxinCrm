...
namespace Repository.Migrations
{
    ...
    [Migration("20210401132540_新增上课记录表")]
    partial class 新增上课记录表
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Database.TMember", b =>
                {
                    ...
                    b.Property<DateTime?>("CourseUpdate")
                        .HasColumnType("datetime2")
                        .HasColumnName("courseupdate");

                    b.Property<Guid?>("CourseUpdateUserId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("courseupdateuserid");
            ...
            modelBuilder.Entity("Repository.Database.TMenmberGoLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("GoCourseCount")
                        .HasColumnType("int")
                        .HasColumnName("gocoursecount");

                    b.Property<bool>("IsDelete")
                        .HasColumnType("bit")
                        .HasColumnName("isdelete");

                    b.Property<int>("LastCourseCount")
                        .HasColumnType("int")
                        .HasColumnName("lastcoursecount");
            ...
            modelBuilder.Entity("Repository.Database.TMember", b =>
                {
                    ...
                    b.HasOne("Repository.Database.TUser", "CourseUpdateUser")
                        .WithMany()
                        .HasForeignKey("CourseUpdateUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Repository.Database.TMenmberGoLog", b =>
                {
                    ...
                    b.HasOne("Repository.Database.TMember", "Member")
                        .WithMany()
